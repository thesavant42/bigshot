...
- the Top 5 programs, divided by project  
 - Top 5 paying programs, with details Per program, sorted by recent payout will be returned as results:
 	 "Program One - Savants Demo"
	 ...
	 - "There are 42 hackers engaged in this project."
...
# What else is new trigger a function that queries for meaningful updates: new notifications, new invitations, changes in status for open items in my hackerone profile), OSO reads me a description of these events in summary, and I can ask for more details.
...
User asks: "OSO, check my reputation, how is the trend over time? What actions can I taake to quickly increase my rank? Search the web."
OSO replies: "Your score is currently 42 for this period, and is trending UPWARD. The next 5 hackers above you are 100 points+ ahead.I am not sure how to increase your rank, let me search the web...." <<searches with bravesearch>> "According to madeup site.com, you can do glalllalallala to quickly gain 100 points"

User query to the AI: "OSO, for each of the Top 5 biggest payts this $PERIOD, 
 1. add them each to my faovrites list, 
...
## On HOSTS and other classifiers
