...
- Q: Do we implement offline report editing?
 - A: This is an interesting question, what do you mean by offline report editing?
  -- Clarifying question❓  Do you men hacker1 report submissions for points?
 - A: An online connection to a third-party should not be considered a full-time requirement for this project, only when interacting with third paries.
