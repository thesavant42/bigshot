...
def system_info():
    ...
    try:
        ...
        env_info = {
            ...
            'database_url': os.getenv('DATABASE_URL', '').split('@')[1] if '@' in os.getenv('DATABASE_URL', '') else 'Not configured',
            'redis_url': os.getenv('REDIS_URL', '').split('@')[1] if '@' in os.getenv('REDIS_URL', '') else 'Not configured',
