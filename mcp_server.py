        ...
        async def get_domain_statistics(
            ...
            try:
                with self.app.app_context():
                    ...
                    recent_domains = query.order_by(Domain.created_at.desc()).limit(10).all()
                        ...
                        "recent_discoveries": [
                            {
                                ...
                                "source": d.source,
                                "discovered": d.created_at.isoformat() if d.created_at else None
                            }
