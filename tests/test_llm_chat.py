...
class TestLLMService:
    ...
    def test_function_call_execution(self):
        ...
        with pytest.raises(ValueError):
            llm_service._execute_function_call(
                'invalid_function',
                {}
            )
...
class TestChatAPI:
    ...
    def test_mcp_execute_endpoint(self):
        ...
        response = self.client.post('/api/v1/mcp/execute', 
                                  json={
    ...
    def test_send_message_without_llm(self):
        ...
        response = self.client.post('/api/v1/chat/messages',
                                  json={
                                      'message': 'Hello',
    ...
    def test_conversation_detail_endpoint(self):
        ...
        response = self.client.get('/api/v1/chat/conversations/test-session', headers=self.headers)
