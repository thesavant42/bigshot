...
class TestDomains:
    ...
    def test_create_domain(self, client, auth_headers):
        ...
        response = client.post('/api/v1/domains', json=domain_data, headers=auth_headers)
    ...
    def test_update_domain(self, client, auth_headers, app):
        ...
        response = client.put(f'/api/v1/domains/{domain_id}', json=update_data, headers=auth_headers)
    ...
    def test_enumerate_domains(self, client, auth_headers):
        ...
        response = client.post('/api/v1/domains/enumerate', json=enumeration_data, headers=auth_headers)
